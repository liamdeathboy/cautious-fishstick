	...
	<form id="editgame-form" enctype="multipart/form-data" method="POST">
		<div class="g-d5 games-dashboard">
			<div class="_b-r _5e4">
				...
				<div>
					<textarea rows="15" style="min-height: 339px;" name="eg_description" class="editor-js _text-input _tr5 tinymce eg_description">{{EDIT_GAME_DESCRIPTION}}</textarea>
					<p>
						<button class="btn-p btn-p1 rewriteText rewriteOpenAI" type="button" data-text="{{CHAT_GPT_TEMPLATE_GAME}}">Rewrite (OpenAI)</button>
						<button class="btn-p btn-p1 rewriteText" type="button" data-text="{{CHAT_GPT_TEMPLATE_GAME}}" data-method="rewritespinner">Rewrite (Spinner)</button>
						<button class="btn-p btn-p1 rewriteText" type="button" data-text="{{CHAT_GPT_TEMPLATE_GAME}}" data-method="rewritegoogletranslate">Rewrite (Google Translate)</button>
						<button class="btn-p btn-p1 clickToCopyText" type="button" data-text="{{CHAT_GPT_TEMPLATE_GAME}}">Copy Rewrite Prompt</button>
					</p>
				</div>
				<div class="rewriteResultBox" style="display: none;">
					<p><bold>Rewrite Result</bold> <button class="btn-p btn-p1 clickToCopyText" type="button" data-text="">Copy</button></p>
			...
			<div class="_5e4" style="width: 100%;">
				<div>
					...
					<div class="_yt10">
						<div class="_a6">
							<label>
								<input type="checkbox" name="eg_is_last_rewrite" {{EDIT_GAME_IS_LAST_REWRITE}} style="transform: scale(1.5)">
				...
				<input type="hidden" class="eg_id" name="eg_id" value="{{EDIT_GAME_ID}}">
			</div>
		</div>
