...
<title>{{GAME_META_TITLE}}</title>
<meta http-equiv="x-dns-prefetch-control" content="on" />
<meta name="description" content="{{GAME_META_DESCRIPTION}}">
<meta property="og:title" content="{{GAME_META_NAME}}"/>
<meta property="og:type" content="game"/>
<meta property="og:url" content="{{GAME_META_GAME_URL}}"/>
<meta property="og:image" content="{{GAME_META_IMAGE}}"/>
