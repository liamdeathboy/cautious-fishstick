...
<div class="general-box">
	...
	<hr>
	<a href="/add-wt-to-db.php" class="btn-p btn-p4"><i class="fa fa-plus"></i> Add Walkthrough Video to DB</a>
	<a href="/add-total-games-to-db.php" class="btn-p btn-p4" style="margin-left: 8px;"><i class="fa fa-plus"></i> Add Total Games to DB</a>
