	...
	<li class="_4lf {{NAV_MENU_GAMES_IMAGES_AND_VIDEOS}}" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
		<a href="{{CONFIG_SITE_URL}}/admin/games-images-and-videos" class="spf-link _p"></a>
		<i class="fa fa-gamepad nav-icon icon-middle"></i> Games Images and Videos
	</li>
	...
	<li class="_4lf {{NAV_MENU_CHATGPT}}">
		<a href="{{CONFIG_SITE_URL}}/admin/chatgpt" class="spf-link _p"></a>
		<i class="fa fa-flag-o nav-icon icon-middle"></i> @menu_chatgpt@
	</li>
	<li class="_4lf {{NAV_MENU_LINKS}}">
		<a href="{{CONFIG_SITE_URL}}/admin/links" class="spf-link _p"></a>
		<i class="fa fa-flag-o nav-icon icon-middle"></i> @menu_links@
	</li>
	<li class="_4lf {{NAV_MENU_SLIDERS}}">
		<a href="{{CONFIG_SITE_URL}}/admin/sliders" class="spf-link _p"></a>
		<i class="fa fa-flag-o nav-icon icon-middle"></i> @menu_slider@
	</li>
	<li class="_4lf {{NAV_MENU_SIDEBAR}}">
		<a href="{{CONFIG_SITE_URL}}/admin/sidebar" class="spf-link _p"></a>
		<i class="fa fa-flag-o nav-icon icon-middle"></i> @menu_sidebar@
	</li>
	<li class="_4lf">
