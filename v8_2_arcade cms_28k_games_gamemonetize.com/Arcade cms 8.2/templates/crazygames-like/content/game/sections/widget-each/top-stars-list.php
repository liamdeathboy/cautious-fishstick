<a href="{{WIDGET_TOPSTAR_URL}}" aria-label="{{WIDGET_TOPSTAR_NAME}}" data-wt-video="{{WIDGET_TOPSTAR_WT_VIDEO}}" class="relative" >
    ...
    <p class="px-2 mt-2 text-xs font-bold text-center text-white truncate lg:hidden" data-url="{{WIDGET_TOPSTAR_VIDEO_URL}}" data-scale="1.2" data-translate="-23px,-25px">{{WIDGET_TOPSTAR_NAME}}</p>
</a>